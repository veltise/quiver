  ...
  return (
    <>
      ...
      <div className="fixed z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-surface border border-border rounded-xl shadow-2xl p-6 w-96">
        <h2 className="text-body font-semibold text-text mb-1">Share this request</h2>
        ...
        <div className="mb-4 bg-warning/10 border border-warning/25 rounded-lg px-3 py-2.5">
          <div className="flex items-center gap-1.5 text-body text-warning font-medium mb-1">
            <ShieldAlert size={12} />
        ...
        <div className="flex gap-2 justify-end">
          ...
          <button
            onClick={onConfirm}
            disabled={sharing}
            className="chamfer-sm text-body px-4 py-2 bg-accent hover:bg-accent-hover disabled:opacity-50 disabled:cursor-not-allowed font-semibold transition-colors text-ink"
          >
